...
class SegmenterOrigin(nn.Module):
    def __init__(
        self,
        encoder,
        decoder,
...
def create_segmenter(args):
    ...
    decoder = sg_vit_mask_decoder(patch_size=patch_size, encoder_embed_dim=encoder_embed_dim,
                                  ...
                                  decoder_num_heads=args.decoder_num_head, n_cls=args.num_classes)
    # model = Segmenter(encoder, decoder)  # Ours
    model = SegmenterOrigin(encoder, decoder)  # Segmenter
